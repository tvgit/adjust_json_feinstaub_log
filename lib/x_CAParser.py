...
def x_parser(command = '', cfg_path_tmp=''):
    # p_log_this()
    parser = confargparse.ConfArgParser(description='Program: feinstaub_data_to_database.py')
...
if __name__ == "__main__":
    ...
    print '|',
    p_log_init(log_dir = r'.\addjust_json_feinstaub_log\log', log_fn = r'x_CAParser')
    p_log_start()
